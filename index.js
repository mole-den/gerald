...
bot.on('ready', () =>{
    ...
    bot.user.setPresence({ activity: { name: "Project Flicker", type: "WATCHING" }, status: "online" });
});  
...
bot.on('message', message => {
	...
	//tham keep this stuff here :)	 or dont idk how command handlers work
		...
		const channel = member.guild.channels.find(channel => channel.name === "labyrinth-" + labyrID);
		...
		message.channel.send(`Labyrinth created, ${labyrplayer}! ${channel}`); //${id} doesnt work 
